...
function Lightbox() {
  ...
  function l(t, e) {
    ...
    return (
      t.getAttribute
        ? (n = t.getAttribute(e))
        : t.getAttributeNode && (n = t.getAttributeNode(e).value),
      !(!a(n) || "" === n) && n
    );
  }
  function p(t, e) {
  ...
  function m(t) {
    for (var e = [], n = 0; n < W.thumbnails.length; n++)
      l(W.thumbnails[n], z + "-group") === t && e.push(W.thumbnails[n]);
    return e;
  }
  function g(t, e) {
  ...
  function d() {
    if (j) {
      var t = new Image(),
        ...
        n = g(V, j);
      n === P.length - 1
        ? ((t.src = l(P[P.length - 1], z) || P[P.length - 1].src),
          (e.src = l(P[0].src, z) || P[0].src))
        : 0 === n
        ? ((t.src = l(P[P.length - 1], z) || P[P.length - 1].src),
          (e.src = l(P[1], z) || P[1].src))
        : ((t.src = l(P[n - 1], z) || P[n - 1].src),
          (e.src = l(P[n + 1], z) || P[n + 1].src));
    }
  }
  function f() {
    if (!M) {
      ...
      var t = function () {
        if (
          (r(W.box, O + "-loading"),
          !N && "number" == typeof W.opt.loadingAnimation)
        ) {
          var t = 0;
  ...
  function h() {
    if (
      !M &&
      (i(W.box, O + "-loading"),
      !N && "string" != typeof W.opt.loadingAnimation && W.opt.loadingAnimation)
    ) {
      clearInterval(w);
  ...
  function v() {
    if (!X) {
      if (
        ((X = document.createElement("span")), r(X, O + "-next"), W.opt.nextImg)
      ) {
    ...
    if ((r(X, O + "-active"), !$)) {
      if (
        (($ = document.createElement("span")), r($, O + "-prev"), W.opt.prevImg)
      ) {
  ...
  function x(t) {
    ...
    if (
      ...
      (W.opt = {
        ...
        animation:
          "number" == typeof t.animation || !1 === t.animation
            ? t.animation
            : 400,
        responsive: e(t.responsive),
        maxImgSize: t.maxImgSize || 0.8,
    ...
    if (
      ((W.box.innerHTML = B),
      M && r(W.box, O + "-ie8"),
      (W.wrapper = document.getElementById(T + "-contentwrapper")),
      !W.opt.hideCloseBtn)
    ) {
      var l = document.createElement("svg");
      l.setAttribute("id", T + "-close"),
        l.setAttribute("class", O + "-close"),
        (l.innerHTML = ""),
        W.box.appendChild(l),
        n(
          l,
    ...
    if (
      ...
      "string" == typeof W.opt.loadingAnimation)
    )
      (y = document.createElement("img")).setAttribute(
        "src",
        W.opt.loadingAnimation
      ),
        r(y, O + "-loading-animation"),
        W.box.appendChild(y);
    else if (W.opt.loadingAnimation) {
      (W.opt.loadingAnimation =
        "number" == typeof W.opt.loadingAnimation
          ? W.opt.loadingAnimation
          : 200),
        r((y = document.createElement("div")), O + "-loading-animation");
      for (var p = 0; p < W.opt.animElCount; )
        q.push(y.appendChild(document.createElement("span"))), p++;
      W.box.appendChild(y);
    }
    W.opt.responsive
      ? (n(
        ...
        r(W.box, O + "-nooverflow"))
      : i(W.box, O + "-nooverflow"),
      W.opt.keyControls &&
        n(
          document,
          "keydown",
  ...
  function A(t, e, i, p) {
    if (!t && !e) return !1;
    (j = e || j || l(t, z + "-group")) &&
      ((P = m(j)), "boolean" != typeof t || t || (t = P[0])),
      (D.img = new Image()),
      (V = t);
    var c;
    (c = "string" == typeof t ? t : l(t, z) ? l(t, z) : l(t, "src")),
      (L = !1),
      R ||
        ("number" == typeof W.opt.animation &&
          r(D.img, O + "-animate-transition " + O + "-animate-init"),
        (R = !0),
        W.opt.onopen && W.opt.onopen(D)),
      (W.opt && a(W.opt.hideOverflow) && !W.opt.hideOverflow) ||
        S.setAttribute("data-lightbox", "on"),
      W.box.setAttribute("style", "padding-top: 0"),
      (W.wrapper.innerHTML = ""),
      W.wrapper.appendChild(D.img),
      W.opt.animation && r(W.wrapper, O + "-animate");
    var u = l(t, z + "-caption");
    if (u && W.opt.captions) {
      var g = document.createElement("p");
      g.setAttribute("class", O + "-caption"),
        (g.innerHTML = u),
        W.wrapper.appendChild(g);
    }
    r(W.box, O + "-active"),
      M && r(W.wrapper, O + "-active"),
      W.opt.controls && P.length > 1 && (v(), b()),
      (D.img.onerror = function (t) {
        W.opt.onloaderror &&
          ((t._happenedWhile = p || !1), W.opt.onloaderror(t));
      }),
      (D.img.onload = function () {
        if (
          ((D.originalWidth = this.naturalWidth || this.width),
          (D.originalHeight = this.naturalHeight || this.height),
          M || N)
        ) {
          var t = new Image();
          t.setAttribute("src", c),
            (D.originalWidth = t.width),
            (D.originalHeight = t.height);
        }
        var e = setInterval(function () {
          o(W.box, O + "-active") &&
            (r(W.wrapper, O + "-wrapper-active"),
            "number" == typeof W.opt.animation &&
              r(D.img, O + "-animate-transition"),
            i && i(),
            h(),
            clearTimeout(I),
            W.opt.preload && d(),
            W.opt.nextOnClick &&
              (r(D.img, O + "-next-on-click"),
              n(
                D.img,
                "click",
                function (t) {
            ...
            W.opt.onload && W.opt.onload(p),
            clearInterval(e),
            W.resize());
        }, 10);
      }),
      D.img.setAttribute("src", c),
      f();
  }
  var y,
    w,
    ...
    B =
      '<div class="jslghtbx-contentwrapper" id="jslghtbx-contentwrapper" ></div>',
    L = !1,
    j = !1,
    V = !1,
    D = {},
  ...
  (W.opt = {}),
    ...
    (W.wrapper = !1),
    (W.thumbnails = []),
    (W.thumbnails.push = function () {
      for (var t = 0, e = arguments.length; t < e; t++) c(arguments[t]);
      return Array.prototype.push.apply(this, arguments);
    }),
    (W.load = function (t) {
      navigator.appVersion.indexOf("MSIE 8") > 0 && (M = !0),
        navigator.appVersion.indexOf("MSIE 9") > 0 && (N = !0),
        x(t);
      for (
        var e = document.querySelectorAll("[" + z + "]"), n = 0;
        n < e.length;
        n++
      )
        p(e[n], z) &&
          (e[n].setAttribute(z + "-index", n), W.thumbnails.push(e[n]));
    }),
    (W.open = function (t, e) {
      t && e && (e = !1), A(t, e, !1, !1);
    }),
    (W.resize = function () {
      if (D.img) {
        ...
        !L &&
          ...
          D.img.offsetWidth &&
          D.img.offsetHeight &&
          (L = D.img.offsetWidth / D.img.offsetHeight),
          Math.floor(n / L) > o
            ? ((E = o * L), (H = o))
            : ((E = n), (H = n / L)),
          (E = Math.floor(E * W.opt.maxImgSize)),
          (H = Math.floor(H * W.opt.maxImgSize)),
          ((W.opt.dimensions && H > D.originalHeight) ||
            (W.opt.dimensions && E > D.originalWidth)) &&
            ((H = D.originalHeight), (E = D.originalWidth)),
          D.img.setAttribute("width", E),
          D.img.setAttribute("height", H),
          D.img.setAttribute("style", "margin-top:" + (t() - H) / 2 + "px"),
          setTimeout(b, 200),
          W.opt.onresize && W.opt.onresize(D);
      }
    }),
    (W.next = function () {
      if (j) {
    ...
    (W.close = function () {
      ...
      (D = {}),
        ...
        (R = !1),
        i(W.box, O + "-active"),
        i(W.wrapper, O + "-wrapper-active"),
        i(X, O + "-active"),
        i($, O + "-active"),
        W.box.setAttribute("style", "padding-top: 0px"),
        h(),
        M && W.box.setAttribute("style", "display: none"),
        (W.opt && a(W.opt.hideOverflow) && !W.opt.hideOverflow) ||
          S.setAttribute("data-lightbox", "off"),
        W.opt.onclose && W.opt.onclose(t);
    });
}
// detect swipe
...
function handlePosts(e) {
  ...
  t &&
    ...
    document.fonts.load('1rem "Inter var"').then(function () {
