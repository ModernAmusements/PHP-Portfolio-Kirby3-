...
function handlePosts(e) {
    ...
    t && t.addEventListener("click", function () {
        ...
        r.forEach(function (e, t) {
            e.children[0].children[0].offsetWidth >= e.children[0].offsetWidth && e.classList.add("long-title")
        })   // show all kat.
        ...
        i.children[0].addEventListener("mouseenter", function (e) {
            ...
            if (!i.classList.contains("toggle") && (i.classList.contains("post-header") ))
            {
