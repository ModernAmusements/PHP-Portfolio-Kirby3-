        ...
        value: function render() {
            ...
            if (this.props.settings.gridActive) {
                ...
                for (var i = 0; i < this.props.settings.gridRows; i++) {
                    ...
                    rows.push(React.createElement("line", {
                ...
                for (var _i = 0; _i < this.props.settings.gridColumns; _i++) {
                    ...
                    cols.push(React.createElement("line", {
                        vectorEffect: "non-scaling-stroke",
                        key: 'col-' + _i,
                        x1: _x,
                        y1: _y,
            ...
            for (var _i2 = 0; _i2 < positionsList.length; _i2++) {
                ...
                if (positionsList[_i2] === "1") {
                    elements.push(React.createElement(Shape, {
                        key: "shape-" + _i2,
                        shape: this.props.settings.elementShape,
                        rotate: rotate,
                        transform: transform,
                        width: defaultSize,
                        height: defaultSize,
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(TextInput, {
                    ...
                    value: this.props.settings.text,
                    title: "Text",
                    id: "text"
                }),
                React.createElement(Dropdown, {
                    updateSetting: this.props.updateSetting,
                    options: ['circle', 'rect'],
                    value: this.props.settings.elementShape,
                    id: "elementShape",
                    title: "Element Shape"
                }),
                React.createElement(Slider, {
                    updateSetting: this.props.updateSetting,
                    value: this.props.settings.elementScaleX,
                    title: "Element Scale X",
                    id: "elementScaleX",
                    min: "0.01",
                    max: "10",
                    step: ".1"
                ...
                React.createElement(Slider, {
                    updateSetting: this.props.updateSetting,
                    value: this.props.settings.elementScaleY,
                    title: "Element Scale Y",
                    id: "elementScaleY",
                    min: "0.01",
                    max: "10",
                    step: ".1"
                ...
                React.createElement(Slider, {
                    updateSetting: this.props.updateSetting,
                    value: this.props.settings.elementRotation,
                ...
                React.createElement(Slider, {
                    updateSetting: this.props.updateSetting,
                    value: this.props.settings.gridSkew,
                    title: "Grid Skew",
                    id: "gridSkew",
                    min: "-350",
                    max: "350",
                ...
                React.createElement(Slider, {
                    updateSetting: this.props.updateSetting,
                    value: this.props.settings.cellHeight,
                    title: "Cell Height",
                    id: "cellHeight",
                    min: "5",
                    max: "150",
                ...
                React.createElement(Slider, {
                    updateSetting: this.props.updateSetting,
                    value: this.props.settings.cellWidth,
                    title: "Cell Width",
                    id: "cellWidth",
                    min: "5",
                    max: "150",
                ...
                React.createElement(Slider, {
                    updateSetting: this.props.updateSetting,
                    value: this.props.settings.spacing,
                    title: "Spacing",
                    id: "spacing",
                    min: "-150",
                    max: "150",
            ...
            var glyphs = letters.map(function(g, i) {
                if (design.grids[_this8.state.settings.gridID].letters[g]) {
                    ...
                    return React.createElement(Glyph, {
                        key: "glyph-" + i,
                        settings: _this8.state.settings,
                        g: g,
                        y: baseY,
                        x: currentX
                    });
